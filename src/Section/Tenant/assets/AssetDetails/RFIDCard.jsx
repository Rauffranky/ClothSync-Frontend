...
const RFIDCard = ({ data }) => {
    return (
        <Card bodyClassName="flex flex-col gap-5">
            ...
            <Card>
                <div className="text-xs font-bold uppercase tracking-wider text-(--theme-text-muted)">Tag EPC <span className="text-(--theme-text-primary)">({data.rfid.tagId})</span></div>
            ...
            <div className="">
                <div className="text-xs font-bold uppercase tracking-wider text-(--theme-text-muted)">Linked Date <span className="text-(--theme-text-primary)">({data.rfid.linkedDate})</span></div>

            </div>

            <Alert variant="orange" rounded="rounded-xl">
                <div className="flex flex-col gap-1">
                    <div className="text-xs font-bold uppercase tracking-wider">Previous Tag</div>
